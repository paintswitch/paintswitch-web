...
- **Confirmed:** Use `hello@paintswitch.com` as PaintSwitch's primary domain mailbox. The owner reported the mailbox working on 2026-08-03; a test email was sent, but receipt and complete inbound/outbound acceptance remain unconfirmed.
...
- **Confirmed:** `hello@paintswitch.com` is also the owner-notification destination. The owner reports that the mailbox works and a test email was sent, but receipt has not been confirmed; the workflow remains Draft and unpublished. Approved on 2026-08-03 under D-029.
