...
- **Confirmed:** Alex is the conditional backup only after `alex@paintswitch.com` is created and a controlled receipt test passes. Mailbox creation, the receipt test, routing, and a response rehearsal remain incomplete.
